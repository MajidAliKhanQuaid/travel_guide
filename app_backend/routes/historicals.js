...
router.post("/search", function (req, res, next) {
  console.log("search historicals place", req.body.query);
  req.db.collection("historicals").find({name:{'$regex' : `${req.body.query}`, '$options' : 'i'}})
  .toArray()
  .then((historicals) =>  res.send(historicals))
  .catch((err) => res.send([]))
