        ...
        <div className="col-md-8">
          <Figure>
            <Figure.Image
              style={{ width: "100%" }}
              alt={`kashmir-1.jpg`}
              src={`${process.env.PUBLIC_URL}/assets/images/kashmir-1.jpg`}
            />
          </Figure>
        </div>
            ...
            <div className="col-md-6">
              <Figure>
                <Figure.Image
                  style={{ width: "100%" }}
                  alt={`kashmir-2.jpg`}
                  src={`${process.env.PUBLIC_URL}/assets/images/kashmir-2.jpg`}
                />
              </Figure>
            </div>
            <div className="col-md-6">
              <Figure>
                <Figure.Image
                  style={{ width: "100%" }}
                  alt={`kashmir-3.jpg`}
                  src={`${process.env.PUBLIC_URL}/assets/images/kashmir-3.jpg`}
                />
              </Figure>
            </div>
          </div>
            ...
            <div className="col-md-6">
              <Figure>
                <Figure.Image
                  style={{ width: "100%" }}
                  alt={`kashmir-4.jpg`}
                  src={`${process.env.PUBLIC_URL}/assets/images/kashmir-4.jpg`}
                />
              </Figure>
            </div>
            <div className="col-md-6">
              <Figure>
                <Figure.Image
                  style={{ width: "100%" }}
                  alt={`kashmir-5.jpg`}
                  src={`${process.env.PUBLIC_URL}/assets/images/kashmir-5.jpg`}
                />
              </Figure>
            </div>
          </div>
